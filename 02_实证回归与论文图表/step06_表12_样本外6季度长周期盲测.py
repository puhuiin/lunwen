...
panel = pd.read_csv(os.path.join(OUT, '分析面板_v3_2026Q2补因子_2026-09-10.csv'), parse_dates=['report_date'])
...
# Also write to scripts/_oos_validation_20260910_6Q.py
try:
    scripts_dir = os.path.join(BASE, 'scripts')
    os.makedirs(scripts_dir, exist_ok=True)
    this_code = open(__file__, encoding='utf-8').read()
    open(os.path.join(scripts_dir, '_oos_validation_20260910_6Q.py'), 'w', encoding='utf-8').write(this_code)
except Exception:
    pass
