...
out_mask = (panel['year'] >= 2025) & ~((panel['year']==2025)&(panel['quarter']==3)) & ~((panel['year']==2026)&(panel['quarter']==2))
...
json_path = os.path.join(OUT, '样本外检验_2006_2024_2026.json')
with open(json_path, 'w', encoding='utf-8') as f:
    json.dump(res_oos, f, ensure_ascii=False, indent=2)

csv_path = os.path.join(OUT, '样本外基金得分与表现明细_20260904.csv')
...
open(os.path.join(BASE, 'scripts', '_oos_validation_20260904.py'), 'w', encoding='utf-8').write(this_code)
